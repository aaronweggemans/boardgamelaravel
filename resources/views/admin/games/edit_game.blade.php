                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="number" name="time"
                                                                           ...
                                                                           placeholder="Tijd" value="{{ old('time')}}{{$game->time}}">
                                                                    @if($errors->has('time'))
                                                            ...
                                                            <div class="row mb-2">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <textarea name="description" id="" cols="30"
                                                                              ...
                                                                              rows="5"
                                                                              class="form-control {{ $errors->has('description') ? 'text-danger' : '' }}">{{$game->description}}{{old('description')}}</textarea>
